...
for s = 1, screen.count() do
    tags[s] = awful.tag({ " www ", " terms ", " configs ", "image" }, s, layouts[1])
end
...
globalkeys = awful.util.table.join(
	...
	awful.key({ }, "XF86Launch2", function () exec("~/bin/spegni", false) end),
	...
	-- MPD control
    awful.key({ modkey }, "XF86AudioPlay", function () exec("~/bin/mpd-toggle", false) end),
